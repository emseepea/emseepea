...
Release each public initializer with its generated `@emseepea/testing@0.15.0` development dependency so every affected package is included in the release and can be verified.
