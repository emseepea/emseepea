...
The quality policy and architecture decisions distinguish supported Node.js
compatibility, standalone initializer qualification, semantic evaluation, and
publication gates. The terminology and detail are appropriate for framework
maintainers. No em dashes remain in the reviewed content.
