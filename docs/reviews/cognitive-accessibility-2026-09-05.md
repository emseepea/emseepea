...
## Colocated Example Initializers

Result: PASS after two required wording corrections. Independent
cognitive-accessibility and Markdown accessibility reviews covered the package
and example guidance, quality policy, Changeset, and website pages.

The final wording gives each public initializer one clear repository home. It
uses consistent package names and npm commands, distinguishes the generated
project from its initializer, and contains no emoji or em dashes.

This review covers source prose. It does not establish package publication.

| Reviewed file | SHA-256 of reviewed content |
| --- | --- |
| `.changeset/tidy-coffees-pass.md` | `6dfe7ead2ad2fd0ae723ff65652a119c89b88f379987ee3b337c96d646778513` |
| `QUALITY.md` | `da9df0fed443b6f2d193f67dc9393ab41012168e744220b4b97d72c9406597bd` |
| `README.md` | `e80d452b24583c295f62009348a2b61613cb6211708dd9f0949958e8eaa9ec6b` |
| `examples/backend-no-ui/README.md` | `c8208088011c635bb405cb938b520831a1fc0555c18c55bb666cd887b3945cc1` |
| `examples/basic-no-ui/README.md` | `1fc2424d9bf1d294f2f586d17fd9e99072006e58375f2bacf4db8b98ca5b4d05` |
| `examples/multi-instance/README.md` | `32e1e81ba8c4c70ea5a7241e0e8796b146b0e848cdf3de0c3a26ee04cc186d22` |
| `examples/native-ui/README.md` | `38e80c84a3d7b6b684e2ac6c2a3fcc8eb49524fbc175d62b19d4b7e5bc9f1178` |
| `examples/protected-no-ui/README.md` | `a68d2e14ad24b7c892e9ff3d258462f09e9f7382fdf30a723301dd535d1fba00` |
| `examples/react-tailwind-ui/README.md` | `f021c6db46ce06f29ef30e8070ffc8451fe01f0b8535b6c66279d3a44f3be65c` |
| `examples/resources-prompts/README.md` | `dc5f9b318e4c03c93e2e53a0a4f0b85daec078067da8f1694d6be9fb5221c774` |
