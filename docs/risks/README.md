...
| [R014](R014-performance-gate-misclassifies-a-revision-when-measurement-variance-is-unclassified.active.md) | Performance gate misclassifies a revision when measurement variance is unclassified | Operational | 15 | 15 | Mitigate | Release maintainer | 2027-03-24 |
| [R015](R015-untested-branch-pushes-consume-ci-and-weaken-verification-claims.active.md) | Untested branch pushes consume continuous integration (CI) and weaken verification claims | Operational | 15 | 15 | Mitigate | Framework maintainer | 2027-03-24 |
