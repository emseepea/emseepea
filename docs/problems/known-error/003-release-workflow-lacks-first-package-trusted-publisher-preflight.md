...
**WSJF**: 30.0 — severity 15 × Known Error multiplier 2.0 ÷ S effort 1
...
**Release vehicle**: `.changeset/preflight-first-package.md`
...
- [Risk R007: Release Pipeline Publishes the Wrong or Compromised
  Package](../../risks/R007-release-pipeline-publishes-the-wrong-or-compromised-package.active.md).
