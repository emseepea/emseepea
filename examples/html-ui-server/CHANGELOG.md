...
- [`d9049e9`](https://github.com/emseepea/emseepea/commit/d9049e93a5e8d8d97f6b854e2796fe20fd4b43ce) Thanks [@tompahoward](https://github.com/tompahoward)! - Accept equivalent wording in the HTML UI semantic test while still requiring preview-only behavior and confirmation that no report was sent or stored.
