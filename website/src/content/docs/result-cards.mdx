...
You need Node.js 22 or newer and an application with a page shell. Continuous
...
<div class="renderer-tabs renderer-tabs--source" role="group" aria-labelledby="install-the-renderer">
  <Tabs syncKey="result-card-renderer">
    <TabItem label="Native HTML">
      <p class="renderer-variant-label">Native HTML</p>
    ...
    <TabItem label="React">
      <p class="renderer-variant-label">React</p>
    ...
    <TabItem label="Svelte">
      <p class="renderer-variant-label">Svelte</p>
...
<div class="renderer-tabs renderer-tabs--source" role="group" aria-labelledby="render-the-current-result">
  <Tabs syncKey="result-card-renderer">
    <TabItem label="Native HTML">
      <p class="renderer-variant-label">Native HTML</p>
